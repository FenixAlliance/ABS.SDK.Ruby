  ...
  class DealUnitCreateDto
    ...
    def self.openapi_types
      {
        ...
        :'deal_unit_lines' => :'Array<DealUnitLineCreateDto>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DealUnitCreateDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DealUnitCreateDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'deal_unit_lines')
        if (value = attributes[:'deal_unit_lines']).is_a?(Array)
          self.deal_unit_lines = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          deal_unit_lines == o.deal_unit_lines
    end
