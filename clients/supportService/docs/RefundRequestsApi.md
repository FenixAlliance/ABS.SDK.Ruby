...
opts = {
  api_version: 'api_version_example', # String | 
  x_api_version: 'x_api_version_example', # String | 
  refund_request_dto_collection_query_parameters: OpenapiClient::RefundRequestDtoCollectionQueryParameters.new # RefundRequestDtoCollectionQueryParameters | 
}
...
| **api_version** | **String** |  | [optional] |
| **x_api_version** | **String** |  | [optional] |
| **refund_request_dto_collection_query_parameters** | [**RefundRequestDtoCollectionQueryParameters**](RefundRequestDtoCollectionQueryParameters.md) |  | [optional] |
...
> <EmptyEnvelope> patch_refund_request_async(tenant_id, refund_request_id, opts)
...
begin
  # Patch a refund request
  result = api_instance.patch_refund_request_async(tenant_id, refund_request_id, opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling RefundRequestsApi->patch_refund_request_async: #{e}"
end
```

#### Using the patch_refund_request_async_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EmptyEnvelope>, Integer, Hash)> patch_refund_request_async_with_http_info(tenant_id, refund_request_id, opts)

```ruby
begin
  # Patch a refund request
  data, status_code, headers = api_instance.patch_refund_request_async_with_http_info(tenant_id, refund_request_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EmptyEnvelope>
rescue OpenapiClient::ApiError => e
  puts "Error when calling RefundRequestsApi->patch_refund_request_async_with_http_info: #{e}"
end
```
