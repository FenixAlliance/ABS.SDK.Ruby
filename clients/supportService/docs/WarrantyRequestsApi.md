...
| [**patch_warranty_request_async**](WarrantyRequestsApi.md#patch_warranty_request_async) | **PATCH** /api/v2/SupportService/WarrantyRequests/{warrantyRequestId} | Patch a warranty request |
...
opts = {
  api_version: 'api_version_example', # String | 
  x_api_version: 'x_api_version_example', # String | 
  warranty_request_dto_collection_query_parameters: OpenapiClient::WarrantyRequestDtoCollectionQueryParameters.new # WarrantyRequestDtoCollectionQueryParameters | 
}
...
| **api_version** | **String** |  | [optional] |
| **x_api_version** | **String** |  | [optional] |
| **warranty_request_dto_collection_query_parameters** | [**WarrantyRequestDtoCollectionQueryParameters**](WarrantyRequestDtoCollectionQueryParameters.md) |  | [optional] |
...
## patch_warranty_request_async

> <EmptyEnvelope> patch_warranty_request_async(tenant_id, warranty_request_id, opts)
...
begin
  # Patch a warranty request
  result = api_instance.patch_warranty_request_async(tenant_id, warranty_request_id, opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling WarrantyRequestsApi->patch_warranty_request_async: #{e}"
end
```

#### Using the patch_warranty_request_async_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EmptyEnvelope>, Integer, Hash)> patch_warranty_request_async_with_http_info(tenant_id, warranty_request_id, opts)

```ruby
begin
  # Patch a warranty request
  data, status_code, headers = api_instance.patch_warranty_request_async_with_http_info(tenant_id, warranty_request_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EmptyEnvelope>
rescue OpenapiClient::ApiError => e
  puts "Error when calling WarrantyRequestsApi->patch_warranty_request_async_with_http_info: #{e}"
end
```
