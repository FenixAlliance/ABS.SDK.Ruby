...
module OpenapiClient
  class SalesLiteratureCreateDto
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SalesLiteratureCreateDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SalesLiteratureCreateDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@content.nil? && @content.to_s.length > 1000
        invalid_properties.push('invalid value for "content", the character length must be smaller than or equal to 1000.')
      end

      if !@content.nil? && @content.to_s.length < 0
      ...
      if !@sales_literature_type_id.nil? && @sales_literature_type_id.to_s.length < 36
        invalid_properties.push('invalid value for "sales_literature_type_id", the character length must be great than or equal to 36.')
      end
    ...
    def valid?
      ...
      return false if !@content.nil? && @content.to_s.length > 1000
    ...
    def content=(content)
      if !content.nil? && content.to_s.length > 1000
        fail ArgumentError, 'invalid value for "content", the character length must be smaller than or equal to 1000.'
      end
    ...
    def sales_literature_type_id=(sales_literature_type_id)
      if !sales_literature_type_id.nil? && sales_literature_type_id.to_s.length > 36
        fail ArgumentError, 'invalid value for "sales_literature_type_id", the character length must be smaller than or equal to 36.'
      end

      if !sales_literature_type_id.nil? && sales_literature_type_id.to_s.length < 36
        fail ArgumentError, 'invalid value for "sales_literature_type_id", the character length must be great than or equal to 36.'
      end

      @sales_literature_type_id = sales_literature_type_id
    end
    ...
    def hash
      [id, timestamp, title, content, description, modified_date, expiration_date, sales_literature_type_id].hash
    end
