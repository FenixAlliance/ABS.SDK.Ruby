...
module OpenapiClient
  class BankGuaranteeCreateDto
    ...
    def hash
      [id, timestamp, margin, charges, beneficiary_name, guarantee_number, guarantee_conditions, fixed_deposit_number, start_date, end_date, validity_in_days, tenant_id, bank_guarantee_type, enrollment_id, contact_id, project_id, order_id, bank_profile_id, bank_account_id, currency_id].hash
    end
