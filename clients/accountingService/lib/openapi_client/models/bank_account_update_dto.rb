...
module OpenapiClient
  class BankAccountUpdateDto
    ...
    def hash
      [group, frozen, name, code, path, prefix, currency_id, account_type_id, parent_account_id, account_category, iban, swift, branch_code, bank_account_number, qualified_name, bank_id, bank_profile_id].hash
    end
