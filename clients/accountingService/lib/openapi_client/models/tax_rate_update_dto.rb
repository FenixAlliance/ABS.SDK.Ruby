...
module OpenapiClient
  class TaxRateUpdateDto
    ...
    def hash
      [name, rate, value, um, unit_id, unit_group_id, priority, compound, shipping, withholding, single_transaction_threshold, cumulative_transaction_threshold, fiscal_authority_id, fiscal_year_id, tenant_id, country_id, tax_class_id, currency_id, tax_policy_id, enrollment_id].hash
    end
