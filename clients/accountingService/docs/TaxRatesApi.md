...
opts = {
  api_version: 'api_version_example', # String | 
  x_api_version: 'x_api_version_example', # String | 
  tax_rate_dto_collection_query_parameters: OpenapiClient::TaxRateDtoCollectionQueryParameters.new # TaxRateDtoCollectionQueryParameters | 
}
...
| **api_version** | **String** |  | [optional] |
| **x_api_version** | **String** |  | [optional] |
| **tax_rate_dto_collection_query_parameters** | [**TaxRateDtoCollectionQueryParameters**](TaxRateDtoCollectionQueryParameters.md) |  | [optional] |
...
> <EmptyEnvelope> patch_tax_rate(tenant_id, id, opts)
...
begin
  # Patch a tax rate
  result = api_instance.patch_tax_rate(tenant_id, id, opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling TaxRatesApi->patch_tax_rate: #{e}"
end
```

#### Using the patch_tax_rate_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EmptyEnvelope>, Integer, Hash)> patch_tax_rate_with_http_info(tenant_id, id, opts)

```ruby
begin
  # Patch a tax rate
  data, status_code, headers = api_instance.patch_tax_rate_with_http_info(tenant_id, id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EmptyEnvelope>
rescue OpenapiClient::ApiError => e
  puts "Error when calling TaxRatesApi->patch_tax_rate_with_http_info: #{e}"
end
```
