...
> <PricingRuleDtoEnvelope> get_pricing_rule_by_id(pricing_rule_id, opts)
...
begin
  # Get pricing rule by ID
  result = api_instance.get_pricing_rule_by_id(pricing_rule_id, opts)
  p result
rescue OpenapiClient::ApiError => e
...
> <Array(<PricingRuleDtoEnvelope>, Integer, Hash)> get_pricing_rule_by_id_with_http_info(pricing_rule_id, opts)

```ruby
begin
  # Get pricing rule by ID
  data, status_code, headers = api_instance.get_pricing_rule_by_id_with_http_info(pricing_rule_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <PricingRuleDtoEnvelope>
rescue OpenapiClient::ApiError => e
