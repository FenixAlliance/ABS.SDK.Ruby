...
# Unit tests for OpenapiClient::ItemAttachmentDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ItemAttachmentDto do
  let(:instance) { OpenapiClient::ItemAttachmentDto.new }

  describe 'test an instance of ItemAttachmentDto' do
    it 'should create an instance of ItemAttachmentDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ItemAttachmentDto)
    end
  end
