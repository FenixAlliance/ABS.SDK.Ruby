...
module OpenapiClient
  class ItemAttachmentDto
    ...
    def hash
      [id, timestamp, notes, title, author, is_folder, hash, file_url, file_path, file_name, abstract, key_words, metadata, file_length, content_type, parent_file_id, valid_response, user_id, tenant_id, enrollment_id, social_profile_id, folder_path, item_id].hash
    end
