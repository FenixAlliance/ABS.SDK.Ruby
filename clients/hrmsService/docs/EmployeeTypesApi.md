...
| [**patch_employee_type_async**](EmployeeTypesApi.md#patch_employee_type_async) | **PATCH** /api/v2/HrmsService/EmployeeTypes/{employeeTypeId} | Patch an employee type |
...
opts = {
  api_version: 'api_version_example', # String | 
  x_api_version: 'x_api_version_example', # String | 
  employee_type_dto_collection_query_parameters: OpenapiClient::EmployeeTypeDtoCollectionQueryParameters.new # EmployeeTypeDtoCollectionQueryParameters | 
}
...
| **api_version** | **String** |  | [optional] |
| **x_api_version** | **String** |  | [optional] |
| **employee_type_dto_collection_query_parameters** | [**EmployeeTypeDtoCollectionQueryParameters**](EmployeeTypeDtoCollectionQueryParameters.md) |  | [optional] |
...
## patch_employee_type_async

> <EmptyEnvelope> patch_employee_type_async(tenant_id, employee_type_id, opts)
...
begin
  # Patch an employee type
  result = api_instance.patch_employee_type_async(tenant_id, employee_type_id, opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling EmployeeTypesApi->patch_employee_type_async: #{e}"
end
```

#### Using the patch_employee_type_async_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EmptyEnvelope>, Integer, Hash)> patch_employee_type_async_with_http_info(tenant_id, employee_type_id, opts)

```ruby
begin
  # Patch an employee type
  data, status_code, headers = api_instance.patch_employee_type_async_with_http_info(tenant_id, employee_type_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EmptyEnvelope>
rescue OpenapiClient::ApiError => e
  puts "Error when calling EmployeeTypesApi->patch_employee_type_async_with_http_info: #{e}"
end
```
