...
opts = {
  ...
  course_library_create_dto: OpenapiClient::CourseLibraryCreateDto.new({title: 'title_example', course_id: 'course_id_example', business_id: 'business_id_example'}) # CourseLibraryCreateDto | 
}
