...
opts = {
  ...
  course_handout_create_dto: OpenapiClient::CourseHandoutCreateDto.new({name: 'name_example', course_id: 'course_id_example', business_id: 'business_id_example'}) # CourseHandoutCreateDto | 
}
