...
opts = {
  ...
  course_page_create_dto: OpenapiClient::CoursePageCreateDto.new({title: 'title_example', course_id: 'course_id_example', business_id: 'business_id_example'}) # CoursePageCreateDto | 
}
