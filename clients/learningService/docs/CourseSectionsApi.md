...
opts = {
  ...
  course_section_create_dto: OpenapiClient::CourseSectionCreateDto.new({name: 'name_example', course_id: 'course_id_example', business_id: 'business_id_example'}) # CourseSectionCreateDto | 
}
