...
opts = {
  ...
  course_cohort_create_dto: OpenapiClient::CourseCohortCreateDto.new({name: 'name_example', course_id: 'course_id_example', business_id: 'business_id_example'}) # CourseCohortCreateDto | 
}
