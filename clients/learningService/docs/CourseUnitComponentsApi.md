...
opts = {
  ...
  course_unit_component_create_dto: OpenapiClient::CourseUnitComponentCreateDto.new({title: 'title_example', course_id: 'course_id_example', business_id: 'business_id_example'}) # CourseUnitComponentCreateDto | 
}
