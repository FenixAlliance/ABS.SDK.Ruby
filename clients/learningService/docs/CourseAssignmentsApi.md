...
opts = {
  ...
  course_assignment_create_dto: OpenapiClient::CourseAssignmentCreateDto.new({title: 'title_example', course_id: 'course_id_example', business_id: 'business_id_example'}) # CourseAssignmentCreateDto | 
}
