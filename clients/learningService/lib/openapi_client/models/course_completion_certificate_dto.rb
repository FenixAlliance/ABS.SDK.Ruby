...
module OpenapiClient
  class CourseCompletionCertificateDto
    ...
    attr_accessor :student_last_name
    ...
    attr_accessor :instructor_last_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CourseCompletionCertificateDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CourseCompletionCertificateDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'student_name')
        self.student_name = attributes[:'student_name']
      end

      if attributes.key?(:'student_last_name')
        self.student_last_name = attributes[:'student_last_name']
      end

      if attributes.key?(:'course_title')
      ...
      if attributes.key?(:'instructor_name')
        self.instructor_name = attributes[:'instructor_name']
      end

      if attributes.key?(:'instructor_last_name')
        self.instructor_last_name = attributes[:'instructor_last_name']
      end
    end
    ...
    def hash
      [id, timestamp, student_profile_id, course_enrollment_id, business_id, business_profile_record_id, course_completion_certificate_template_id, course_id, student_name, student_last_name, course_title, total_effort_in_hours, instructor_name, instructor_last_name].hash
    end
