...
opts = {
  api_version: 'api_version_example', # String | 
  x_api_version: 'x_api_version_example', # String | 
  social_post_comment_create_dto: OpenapiClient::SocialPostCommentCreateDto.new({message: 'message_example'}) # SocialPostCommentCreateDto | 
}
...
> <SocialReactionDtoEnvelope> create_social_post_reaction_async(social_post_id, social_profile_id, opts)
...
> <Array(<SocialReactionDtoEnvelope>, Integer, Hash)> create_social_post_reaction_async_with_http_info(social_post_id, social_profile_id, opts)
...
> <EmptyEnvelope> update_social_post_reaction_async(social_profile_id, social_post_id, reaction_id, opts)
...
> <Array(<EmptyEnvelope>, Integer, Hash)> update_social_post_reaction_async_with_http_info(social_profile_id, social_post_id, reaction_id, opts)
