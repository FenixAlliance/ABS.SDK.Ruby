...
module OpenapiClient
  class ConversationDto
    ...
    attr_accessor :started_timestamp
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ConversationDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ConversationDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'started_timestamp')
        self.started_timestamp = attributes[:'started_timestamp']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          started_timestamp == o.started_timestamp &&
    ...
    def hash
      [id, timestamp, subject, social_profile_id, started_timestamp, last_message_timestamp, last_message, social_profile_name, social_profile_avatar_url].hash
    end
