...
module OpenapiClient
  class SocialCommentReactionDto
    ...
    attr_accessor :social_comment_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SocialCommentReactionDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SocialCommentReactionDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'reaction_value')
        self.reaction_value = attributes[:'reaction_value']
      end
      ...
      if attributes.key?(:'social_comment_id')
        self.social_comment_id = attributes[:'social_comment_id']
      end
    end
    ...
    # @param [Object] reaction Object to be assigned
    def reaction=(reaction)
      validator = EnumAttributeValidator.new('String', ["Like", "Happy", "HaHa", "Love", "Sad", "Angry", "Wow", "Afraid"])
      unless validator.valid?(reaction)
        fail ArgumentError, "invalid value for \"reaction\", must be one of #{validator.allowable_values}."
      end
      @reaction = reaction
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          social_comment_id == o.social_comment_id
    end
    ...
    def hash
      [id, timestamp, reaction, reaction_value, social_profile_id, social_profile_name, social_profile_avatar_url, social_profile_type, social_comment_id].hash
    end
