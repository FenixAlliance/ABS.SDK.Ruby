...
module OpenapiClient
  class SocialPostCommentDto
    ...
    attr_accessor :social_feed_post_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SocialPostCommentDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SocialPostCommentDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'social_feed_post_id')
        self.social_feed_post_id = attributes[:'social_feed_post_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          social_feed_post_id == o.social_feed_post_id &&
    ...
    def hash
      [id, timestamp, message, parent_comment_id, social_profile_id, social_feed_post_id, social_profile_name, social_profile_avatar_url, social_profile_type, body_html, body_format, reply_count, reactions_count, social_post_id, facepile, my_reaction, my_reaction_id].hash
    end
