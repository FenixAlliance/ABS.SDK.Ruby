  ...
  class ExtendedContactDto
    ...
    def self.openapi_types
      {
        ...
        :'parent_contact' => :'SimpleContactDto',
        :'primary_contact' => :'SimpleContactDto'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ExtendedContactDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ExtendedContactDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'parent_contact')
        self.parent_contact = attributes[:'parent_contact']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          parent_contact == o.parent_contact &&
