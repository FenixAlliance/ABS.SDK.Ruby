  ...
  class LicenseKeyRequest
    ...
    def self.openapi_types
      {
        ...
        :'additional_attributes' => :'Array<AdditionalAttribute>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::LicenseKeyRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::LicenseKeyRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      license_type_validator = EnumAttributeValidator.new('String', ["Trial", "Standard", "Enterprise"])
    ...
    def license_type=(license_type)
      validator = EnumAttributeValidator.new('String', ["Trial", "Standard", "Enterprise"])
    ...
    def hash
      [user_id, tenant_id, order_id, payment_id, invoice_id, enrollment_id, entitlement_id, seats, license_type, expiration_date, features, additional_attributes].hash
    end
