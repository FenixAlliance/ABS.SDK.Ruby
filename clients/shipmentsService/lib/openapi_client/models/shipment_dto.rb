...
module OpenapiClient
  class ShipmentDto
    ...
    def hash
      [id, timestamp, tracking_code, is_international, shipped, delivered, shipment_timestamp, delivery_timestamp, expected_shipping_date, expected_delivery_date, shipping_terms, order_id, tenant_id, seller_billing_profile_id, buyer_billing_profile_id].hash
    end
