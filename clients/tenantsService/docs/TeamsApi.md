...
| [**patch_tenant_team**](TeamsApi.md#patch_tenant_team) | **PATCH** /api/v2/TenantsService/Teams/{tenantTeamId} | Patch a tenant team |
...
opts = {
  ...
  tenant_team_create_dto: OpenapiClient::TenantTeamCreateDto.new # TenantTeamCreateDto | 
}
...
opts = {
  api_version: 'api_version_example', # String | 
  x_api_version: 'x_api_version_example', # String | 
  tenant_team_dto_collection_query_parameters: OpenapiClient::TenantTeamDtoCollectionQueryParameters.new # TenantTeamDtoCollectionQueryParameters | 
}
...
| **api_version** | **String** |  | [optional] |
| **x_api_version** | **String** |  | [optional] |
| **tenant_team_dto_collection_query_parameters** | [**TenantTeamDtoCollectionQueryParameters**](TenantTeamDtoCollectionQueryParameters.md) |  | [optional] |
...
> <EmptyEnvelope> patch_tenant_team(tenant_id, tenant_team_id, opts)
...
begin
  # Patch a tenant team
  result = api_instance.patch_tenant_team(tenant_id, tenant_team_id, opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling TeamsApi->patch_tenant_team: #{e}"
end
```

#### Using the patch_tenant_team_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EmptyEnvelope>, Integer, Hash)> patch_tenant_team_with_http_info(tenant_id, tenant_team_id, opts)

```ruby
begin
  # Patch a tenant team
  data, status_code, headers = api_instance.patch_tenant_team_with_http_info(tenant_id, tenant_team_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EmptyEnvelope>
rescue OpenapiClient::ApiError => e
  puts "Error when calling TeamsApi->patch_tenant_team_with_http_info: #{e}"
end
```
