...
opts = {
  api_version: 'api_version_example', # String | 
  x_api_version: 'x_api_version_example', # String | 
  marketing_lead_dto_collection_query_parameters: OpenapiClient::MarketingLeadDtoCollectionQueryParameters.new # MarketingLeadDtoCollectionQueryParameters | 
}
...
| **api_version** | **String** |  | [optional] |
| **x_api_version** | **String** |  | [optional] |
| **marketing_lead_dto_collection_query_parameters** | [**MarketingLeadDtoCollectionQueryParameters**](MarketingLeadDtoCollectionQueryParameters.md) |  | [optional] |
...
> <EmptyEnvelope> patch_marketing_lead_async(tenant_id, marketing_lead_id, opts)
...
begin
  # Patch a marketing lead
  result = api_instance.patch_marketing_lead_async(tenant_id, marketing_lead_id, opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling MarketingLeadsApi->patch_marketing_lead_async: #{e}"
end
```

#### Using the patch_marketing_lead_async_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EmptyEnvelope>, Integer, Hash)> patch_marketing_lead_async_with_http_info(tenant_id, marketing_lead_id, opts)

```ruby
begin
  # Patch a marketing lead
  data, status_code, headers = api_instance.patch_marketing_lead_async_with_http_info(tenant_id, marketing_lead_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EmptyEnvelope>
rescue OpenapiClient::ApiError => e
  puts "Error when calling MarketingLeadsApi->patch_marketing_lead_async_with_http_info: #{e}"
end
```
