...
module OpenapiClient
  class OrderCreateDto
    ...
    attr_accessor :total_shipping_tax_in_usd
    ...
    def self.attribute_map
      {
        ...
        :'total_shipping_tax_in_usd' => :'totalShippingTaxInUsd',
    ...
    def self.openapi_types
      {
        ...
        :'total_shipping_tax_in_usd' => :'Float',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::OrderCreateDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::OrderCreateDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'total_shipping_tax_in_usd')
        self.total_shipping_tax_in_usd = attributes[:'total_shipping_tax_in_usd']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total_shipping_tax_in_usd == o.total_shipping_tax_in_usd &&
