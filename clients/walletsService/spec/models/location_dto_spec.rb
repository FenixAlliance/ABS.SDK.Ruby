...
# Unit tests for OpenapiClient::LocationDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::LocationDto do
  let(:instance) { OpenapiClient::LocationDto.new }

  describe 'test an instance of LocationDto' do
    it 'should create an instance of LocationDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::LocationDto)
    end
  end
