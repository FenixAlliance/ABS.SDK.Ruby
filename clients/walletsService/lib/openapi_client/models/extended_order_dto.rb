...
module OpenapiClient
  class ExtendedOrderDto
    ...
    attr_accessor :order_lines_count
    ...
    attr_accessor :seller_billing_profile_id

    attr_accessor :buyer_billing_profile_id
    ...
    def self.openapi_nullable
      Set.new([
        ...
        :'seller_billing_profile_id',
        :'buyer_billing_profile_id',
      ])
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ExtendedOrderDto` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ExtendedOrderDto`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'order_lines_count')
        self.order_lines_count = attributes[:'order_lines_count']
      end
      ...
      if attributes.key?(:'parent_order_id')
        self.parent_order_id = attributes[:'parent_order_id']
      end
      ...
      if attributes.key?(:'qualified_identifier')
        self.qualified_identifier = attributes[:'qualified_identifier']
      end

      if attributes.key?(:'seller_billing_profile_id')
        self.seller_billing_profile_id = attributes[:'seller_billing_profile_id']
      end

      if attributes.key?(:'buyer_billing_profile_id')
        self.buyer_billing_profile_id = attributes[:'buyer_billing_profile_id']
      end
    ...
    def valid?
      ...
      order_status_validator = EnumAttributeValidator.new('String', ["New", "Processing", "Accepted", "Declined", "Shipped", "Delivered", "OnHold", "Failed", "Fulfilled", "Cancelled"])
    ...
    def order_status=(order_status)
      validator = EnumAttributeValidator.new('String', ["New", "Processing", "Accepted", "Declined", "Shipped", "Delivered", "OnHold", "Failed", "Fulfilled", "Cancelled"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          seller_billing_profile_id == o.seller_billing_profile_id &&
          buyer_billing_profile_id == o.buyer_billing_profile_id &&
